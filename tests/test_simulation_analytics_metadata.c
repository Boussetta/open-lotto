...
static void test_metadata_init_and_json(void)
{
    ...
    assert_equals(simulation_analytics_metadata_init(&meta, "Lotto 6aus49", 10000, 1, 42,
                                                     "simulation"),
                  0, "metadata_init returns 0");
...
static void test_invalid_inputs(void)
{
    ...
    assert_equals(simulation_analytics_metadata_init(NULL, "Lotto", 10, 0, 0, "simulation"),
                  -1, "init rejects NULL out");
    assert_equals(simulation_analytics_metadata_init(&meta, "Lotto", 0, 0, 0, "simulation"),
                  -1, "init rejects non-positive run_count");
